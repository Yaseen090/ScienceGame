...
public class ClientUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Create a label
        Text titleText = new Text("Client");
        ...
        submitButton.setOnAction(event -> {
            if (validateMove(gameBoard)) {
                ...
                if(totaltiles>=10)
                {
                    ...
                    client.sendObject(gameBoard.getTempTilesList());
                    serverList = (List) client.receiveObject();
                    for (Tile tile : serverList) {
